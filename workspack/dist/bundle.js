...
var Chinese = function (_Person) {
    (0, _inherits3.default)(Chinese, _Person);

    function Chinese(a) {
        (0, _classCallCheck3.default)(this, Chinese);
        return (0, _possibleConstructorReturn3.default)(this, (Chinese.__proto__ || (0, _getPrototypeOf2.default)(Chinese)).call(this, a));
    }

    (0, _createClass3.default)(Chinese, [{
        key: 'speack',
        value: function speack() {
            console.log('china');
        }
    }]);
    return Chinese;
